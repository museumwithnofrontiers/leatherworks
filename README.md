...
The **Museum With No Frontiers — Leatherwork** gallery, built from the published
dataset `@museumwnf/leatherworks-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/leatherworks-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/leatherworks/> through the reusable workflows in
