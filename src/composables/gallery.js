...
// `useGalleryData.js` used to be byte-identical local copies of what leatherworks
...
// legacy project key, no UUID — leatherworks shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (leatherworks-data 1.0.11+), an outside
