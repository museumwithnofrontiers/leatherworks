...
export default {
  ...
  home: {
    title: 'leatherworks.identity.title',
    intro: 'leatherworks.home.intro',
    cards: [
      {
        title: 'leatherworks.nav.catalogue',
        description: 'leatherworks.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'leatherworks.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'leatherworks.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'leatherworks.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'leatherworks.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'leatherworks.partnerObjects.emptyPartner',
  //         emptyInstitution: 'leatherworks.partnerObjects.emptyInstitution',
  //         institutionSummary: 'leatherworks.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'leatherworks.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'leatherworks.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
