...
export default {
  ...
  siteName: manifest.site?.names?.en ?? 'Leatherwork',
  ...
  // one entry for every project id `npm pack @museumwnf/leatherworks-data`
  // carries in `manifest.projects` (checked 2026-09-19, leatherworks-data 1.0.9).
  ...
  site: { origin: 'https://museumwithnofrontiers.github.io/leatherworks' },
