...
<template>
  <SiteShell
    v-bind="$attrs"
    header-home="#/"
    :footer-text="t('leatherworks.identity.copyright')"
  >
    <template #brand>
      <span class="site-logo">
        <span class="site-logo-org">{{ t('leatherworks.identity.organisation') }}</span>
        <span class="site-logo-title">{{ t('leatherworks.identity.title') }}</span>
      </span>
    </template>
    <slot />
  </SiteShell>
